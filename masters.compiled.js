...
function mLumY(hex) {
  ...
  return 0.2126 * mLin(r) + 0.7152 * mLin(g) + 0.0722 * mLin(b);
}
function mLstar(hex) {
  const Y = mLumY(hex);
...
function mGrey(hex) {
  const Y = mLumY(hex),
    inv = Y <= 0.0031308 ? 12.92 * Y : 1.055 * Math.pow(Y, 1 / 2.4) - 0.055,
    v = Math.round(Math.max(0, Math.min(255, inv * 255)));
  return `rgb(${v},${v},${v})`;
}
const mStr = {
  fill: "none",
...
function pigmentRank(hex) {
  ...
  let h = 0;
  if (delta > 0) {
    if (max === r) h = ((g - b) / delta + (g < b ? 6 : 0)) * 60;else if (max === g) h = ((b - r) / delta + 2) * 60;else h = ((r - g) / delta + 4) * 60;
  }
...
function sortPigments(arr) {
  return [...arr].sort((a, b) => pigmentRank(a.c) - pigmentRank(b.c));
}
...
const MBack = () => /*#__PURE__*/React.createElement("svg", _extends({
  viewBox: "0 0 24 24"
}, mStr, {
  style: {
    width: 16,
...
const MChev = () => /*#__PURE__*/React.createElement("svg", _extends({
  className: "chev",
  viewBox: "0 0 24 24"
}, mStr), /*#__PURE__*/React.createElement("path", {
  d: "m6 15 6-6 6 6"
}));
...
const MDATA = [{
  id: 'northern',
  label: 'Netherlandish',
  full: 'Early Netherlandish & Northern Renaissance',
  period: 'c. 1420–1555',
  artists: [{
    name: 'Jan van Eyck',
    short: 'Van Eyck',
...
const MNOTES = {
  'Lead white': {
    period: 'Ancient – 19th c.',
    origin: 'Corroded lead sheets',
    note: 'The foundational warm-toned white for six centuries of European painting. Its unique opacity, body, and slow-drying quality shaped how every old master built paint structure. Toxic, yet irreplaceable — its warm cream tone still cannot be matched by titanium white.'
  },
  'Lapis lazuli': {
    period: '13th – 18th c.',
    origin: 'Semi-precious stone, Afghanistan',
    note: 'Ground from the gemstone, it cost more than gold. Painters reserved it for the Virgin\'s robe and the highest skies. Its warm violet undertone distinguishes it from synthetic ultramarine; individual stone particles scatter light in a way no ground pigment replicates.'
  },
  'Red madder': {
    period: 'Ancient – present',
    origin: 'Root of Rubia tinctorum',
    note: 'A transparent lake from the dried madder root, used almost exclusively in glazes. Layered over opaque underpaint, it creates depths of crimson impossible in a single application — the cornerstone of Venetian red drapery.'
  },
  'Red ochre': {
    period: 'Prehistoric – present',
    origin: 'Iron oxide mineral',
    note: 'The oldest pigment used by humans. Warm, opaque, absolutely lightfast. Mixed with lead white it yields the classic Venetian flesh mid-tone; in shadow passages it provides the warm undertone that distinguishes southern-school darks from northern ones.'
  },
  'Orpiment': {
    period: 'Ancient – 18th c.',
    origin: 'Arsenic trisulfide mineral',
    note: 'A brilliant arsenic-based yellow from antiquity. Highly toxic and incompatible with lead white and copper pigments — turns black on contact. Painters handled it carefully but prized its pure yellow tone, unmatched until cadmium arrived in the 19th century.'
  },
  'Realgar': {
    period: 'Ancient – 17th c.',
    origin: 'Arsenic monosulfide mineral',
    note: 'A warm orange-red arsenic mineral used alongside orpiment. Like its sister pigment, unstable in light and incompatible with many others. The Venetians used it for the fiery oranges in drapery and landscape that give their work such warmth.'
  },
  'Burnt sienna': {
    period: 'Ancient – present',
    origin: 'Roasted raw sienna, iron oxide',
    note: 'Raw sienna calcined to a deeper, more transparent warm brown. Its transparency makes it ideal for glazing the shadow side of flesh — Titian applied it in thin veils over darker underpaint to create the impression of warmth glowing from within.'
  },
  'Raw sienna': {
    period: 'Ancient – present',
    origin: 'Hydrated iron oxide clay',
    note: 'A warm, transparent golden-brown iron oxide — the unroasted counterpart to burnt sienna. Valued by the Hudson River School painters for its glazing transparency: thin applications over white create luminous warm passages in foliage and atmospheric distance that opaque yellow ochre cannot achieve. Prussian blue added for aerial recession reads cooler and more convincing laid over a raw sienna undertone than over bare white ground.'
  },
  'Malachite': {
    period: 'Ancient – 17th c.',
    origin: 'Basic copper carbonate',
    note: 'A vibrant emerald green ground from the copper mineral. Coarse grinding yields deep green; fine grinding yields pale turquoise. Replaced by verdigris, then viridian — its warm, slightly gritty texture is distinctive in early Venetian panel paintings.'
  },
  'Bone black': {
    period: 'Ancient – present',
    origin: 'Calcined animal bones',
    note: 'Produced by burning animal bones in a closed container. Slightly brownish-black with limited tinting strength but excellent permanence. Used in shadow passages and to modify other colours — never the only black, always a collaborator.'
  },
  'Carmine': {
    period: '16th c. – present',
    origin: 'Cochineal insect extract',
    note: 'A brilliant crimson lake. When cochineal arrived from the New World it replaced older kermes-based carmine and offered deeper, purer reds. Used almost exclusively in glazes; on its own, one of the most luminous reds ever available to painters.'
  },
  'Venetian red': {
    period: '16th c. – present',
    origin: 'Iron oxide, calcined vitriol',
    note: 'A warm brownish-red iron oxide distinct from modern formulations. Tintoretto used it as the dominant warm note in both flesh passages and drapery, building a low-saturation warmth that reads as richly colourful in raking light.'
  },
  'Azurite': {
    period: '13th – 17th c.',
    origin: 'Basic copper carbonate',
    note: 'The blue of northern Europe before affordable ultramarine. Cool, slightly greenish, and opaque. Azurite often darkens to muddy green over time as the copper oxidises — many "gray" skies in old northern paintings were once brilliant azurite blue.'
  },
  'Yellow ochre': {
    period: 'Prehistoric – present',
    origin: 'Hydrated iron oxide clay',
    note: 'The most universally used pigment in the history of painting — from cave walls to academic ateliers. Warm, opaque, and absolutely lightfast. Mixed with white it yields the classic warm flesh mid-tone used by every school from Venice to Paris.'
  },
  'Ivory black': {
    period: 'Ancient – present',
    origin: 'Calcined ivory or bone',
    note: 'The most refined black in the traditional palette. Deep, slightly bluish, with strong tinting power. Caravaggio used it structurally — not as a shadow modifier but as the foundation of the entire dark half of his value scale.'
  },
  'Raw umber': {
    period: 'Ancient – present',
    origin: 'Hydrated iron/manganese oxide',
    note: 'A cool dark brown earth used for underpainting and shadow glazes. Its manganese content makes it the fastest-drying pigment on the traditional palette — Rembrandt and others relied on it to build workable surfaces with remarkable speed.'
  },
  'Vermilion': {
    period: 'Ancient – 19th c.',
    origin: 'Mercuric sulfide',
    note: 'The standard red for six centuries. Made from ground cinnabar or synthesised from mercury and sulfur. Brilliant and opaque but potentially unstable — it can darken to near-black. Cadmium red largely replaced it after the 1850s.'
  },
  'Lead tin yellow': {
    period: '14th – 18th c.',
    origin: 'Lead-tin oxide compound',
    note: 'A warm opaque yellow of extraordinary brightness. Its recipe was lost after the 18th century and only rediscovered through 20th-century technical analysis of paintings. Rembrandt used it for the most brilliantly illuminated passages of fabric and face.'
  },
  'Smalt': {
    period: '15th – 18th c.',
    origin: 'Ground cobalt glass',
    note: 'Made from cobalt-rich potassium glass ground to a blue pigment. It loses colour over time as the binding oil polymerises around the glass particles — many smalt passages are now nearly colourless. Under UV restoration light, the original blue is still visible.'
  },
  'Van Dyke brown': {
    period: '17th c. – present',
    origin: 'Peat and organic matter',
    note: 'A rich, transparent brown of complex organic composition. Extremely slow-drying and prone to cracking — Turner avoided it; Rembrandt used it fearlessly. Its warm depth in glazes is nearly impossible to replicate with modern transparent brown pigments.'
  },
  'Natural ultramarine': {
    period: '13th – 19th c.',
    origin: 'Lapis lazuli stone',
    note: 'Ground from the gemstone. Vermeer used it in extraordinary quantities — even in flesh tones where others would have substituted. The blue-gray of his domestic interiors is simply ultramarine mixed with lead white in varying proportions.'
  },
  'Green earth': {
    period: 'Ancient – present',
    origin: 'Celadonite clay mineral',
    note: 'A cool transparent khaki-green used as a flesh underpainting in the Italian tradition. Visible where upper layers are thin, it creates the characteristic greenish half-tone in early Italian panel paintings that distinguishes southern from northern flesh.'
  },
  'Naples yellow': {
    period: '16th – 19th c.',
    origin: 'Lead antimonate',
    note: 'A warm opaque lead-based yellow with the body and temperature ideal for flesh highlights in academic painting. Bouguereau used it for the highest lights on cheekbones and foreheads. Modern Naples yellow is a mixture formulation with different handling qualities.'
  },
  'Viridian': {
    period: '1838 – present',
    origin: 'Hydrated chromium oxide',
    note: 'Synthesised in the 1830s, viridian offered what no previous green could: a cool, transparent, bright green fully stable and compatible with all other pigments. The Impressionists seized on it for cool shadow passages and atmospheric greens.'
  },
  'Cobalt blue': {
    period: '1802 – present',
    origin: 'Cobalt aluminate',
    note: 'The first major synthetic pigment. Clean, mid-range blue with a slightly violet cast — neither as warm as ultramarine nor as cold as Prussian blue. Remains among the most permanent and stable blues available; the Impressionists used it for skies and clean mixing.'
  },
  'Rose madder': {
    period: 'Ancient – present',
    origin: 'Madder root lake',
    note: 'More delicate and pink-toned than red madder, used for cooler reds and pinks in flesh. Its transparency makes it ideal for glazing over lead or zinc white to create luminous pink passages in academic flesh — particularly in lights and reflected lights.'
  },
  'Chrome yellow': {
    period: '1809 – late 19th c.',
    origin: 'Lead chromate',
    note: 'The first bright yellow of the modern era. Brilliant but prone to darkening to a greenish-brown — van Gogh\'s sunflowers are thought to have shifted from a warmer original tone. Replaced by cadmium yellow as permanence standards tightened.'
  },
  'Zinc white': {
    period: '1834 – present',
    origin: 'Zinc oxide',
    note: 'A cooler, more transparent white than lead white. The Impressionists favoured it for adding white without losing colour temperature. However, it is brittle and prone to cracking in thick applications — a practical limitation that defined how they applied it.'
  },
  'Fr. ultramarine': {
    period: '1826 – present',
    origin: 'Synthetic lapis lazuli',
    note: 'Synthesised in 1826, French ultramarine made the richest blue in painting history affordable. Slightly warmer than cobalt blue with a reddish undertone. Every painter from Delacroix onward used it freely where previously they would have rationed it carefully.'
  },
  'Cobalt violet': {
    period: '1859 – present',
    origin: 'Cobalt phosphate',
    note: 'The only clean, permanent violet available to the Impressionists. Early formulations contained arsenic. Used to push the blue-violet temperature of shadows in contrast with warm orange-yellow complementary lights — a defining move in Sorolla\'s sunlit palette.'
  },
  'Chrome orange': {
    period: '1809 – late 19th c.',
    origin: 'Basic lead chromate',
    note: 'A warm orange-red chromate pigment offering some of the most brilliant warm options available before cadmium. Prone to the same darkening as chrome yellow. Renoir used it alongside vermilion for the deepest saturated oranges in sunlit flesh.'
  },
  'Crimson lake': {
    period: '16th – 19th c.',
    origin: 'Cochineal extract',
    note: 'A warm transparent lake from cochineal. Beautifully luminous in glazes but of limited permanence — most crimson lake passages in 18th-century paintings have faded to a near-transparent ghost of their original saturated crimson.'
  },
  'Cerulean': {
    period: '1860 – present',
    origin: 'Cobalt stannate',
    note: 'A sky-blue with a distinctly greenish, slightly dusty cast — unlike cobalt or ultramarine. Introduced commercially in the 1860s, it gave painters a new option for clear atmospheric blues and remains a distinctive presence in 19th-century sky painting.'
  },
  'Natural madder': {
    period: 'Ancient – 19th c.',
    origin: 'Madder root',
    note: 'The mordant-dyed colorant used as a pigment lake. More orange-warm than later alizarin. Manet and Delacroix used it alongside vermilion for warm glazed passages in drapery — a subtle warmth in the reds that distinguishes their flesh from colder painters.'
  },
  'Emerald green': {
    period: '1814 – 20th c.',
    origin: 'Copper acetoarsenite',
    note: 'Intensely brilliant and slightly blue-green. Highly toxic — suspected in 19th-century poisonings. Its incompatibility with many pigments limited use, but its pure green intensity was unmatched for certain passages before viridian became universal.'
  },
  'Cadmium yellow': {
    period: '1846 – present',
    origin: 'Cadmium sulfide',
    note: 'One of the most important 19th-century introductions — warm, opaque, and fully permanent. Available in lemon, medium, and deep varieties. Replaced chrome yellow as permanence standards tightened; the Impressionists used it for the most luminous sunlit yellows.'
  },
  'Prussian blue': {
    period: '1704 – present',
    origin: 'Iron hexacyanoferrate',
    note: 'The first synthetic pigment, accidentally discovered in Berlin in 1704. Deep, slightly greenish blue with extraordinary tinting strength — a little goes a very long way. Vuillard used it for the deepest architectural shadows in his Nabis interiors.'
  },
  'Alizarin': {
    period: '1868 – present',
    origin: 'Synthetic anthracene derivative',
    note: 'The first synthetic organic pigment, producing the same colorant as madder lake in pure form. Transparent, brilliant crimson with a cold blue undertone. A fundamental transparent red in the studio palette, though lightfastness in thin washes is limited.'
  },
  'Gold leaf': {
    period: 'Ancient – present',
    origin: 'Beaten gold metal',
    note: 'Not a pigment but fundamental to Klimt\'s program. Applied over a mordant, burnished, then painted over. The contrast between warm gold and cooler oil colours gives his work its characteristic shimmering tension between decoration and figuration.'
  },
  'Silver leaf': {
    period: 'Ancient – present',
    origin: 'Beaten silver metal',
    note: 'Provides a cooler metallic note than gold. In Klimt\'s work it suggests moonlight or water surfaces. Unlike gold, silver tarnishes — many silver-leaf passages in his paintings have oxidised to a grayish-brown over the past century.'
  },
  'Cadmium red': {
    period: '1910 – present',
    origin: 'Cadmium sulfoselenide',
    note: 'Available commercially from around 1910, cadmium red gave the Fauves a warm fully opaque red of extraordinary permanence. Its opacity differs from vermilion — it holds intensity in mixtures where vermilion tends to deaden and grey.'
  },
  'Madder lake': {
    period: 'Ancient – 19th c.',
    origin: 'Madder root lake',
    note: 'A warm transparent crimson — the predecessor of alizarin. Matisse used it for the deepest, most transparent red passages, glazing it over opaque underpaint to achieve a luminous depth impossible in a single opaque application.'
  },
  'Cadmium orange': {
    period: '1875 – present',
    origin: 'Cadmium sulfoselenide',
    note: 'A clean, fully opaque orange with extraordinary permanence — unlike the chrome oranges it replaced, it does not darken. Bonnard and Sorolla used it at full intensity, contrasting it against cobalt violet to create the most energetic passages of early 20th-century painting.'
  },
  'Cochineal lake': {
    period: '16th c. – present',
    origin: 'Cochineal insect extract',
    note: 'Introduced from the New World in the 16th century, quickly replacing older carmine sources. Rubens used it for his most vibrant reds — in the glazed shadows of drapery, its transparency creates a depth that opaque vermilion alone could never achieve.'
  }
};
...
const MARTWORKS = {
  'Tiziano Vecelli (Titian)': {
    url: 'https://commons.wikimedia.org/wiki/Special:FilePath/Titian_Venus_of_Urbino.jpg',
    title: 'Venus of Urbino',
    year: '1538',
    museum: 'Uffizi Gallery, Florence'
  },
  'Paolo Veronese': {
    url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/86/Leda_et_le_cygne_par_Paolo_Veronese_1.jpg/960px-Leda_et_le_cygne_par_Paolo_Veronese_1.jpg',
  ...
  'Caravaggio': {
    url: 'https://commons.wikimedia.org/wiki/Special:FilePath/Caravaggio%27s_The_Calling_of_St_Matthew.jpg',
    title: 'The Calling of Saint Matthew',
    year: '1599–1600',
    museum: 'San Luigi dei Francesi, Rome'
  },
  'Peter Paul Rubens': {
    url: 'https://commons.wikimedia.org/wiki/Special:FilePath/Peter_Paul_Rubens_-_Venus,_Amor,_Bacchus_and_Ceres.jpg',
    title: 'Venus, Amor, Bacchus and Ceres',
    year: 'c. 1612–13',
    museum: 'Städel Museum, Frankfurt'
  },
  'Rembrandt van Rijn': {
    url: 'https://commons.wikimedia.org/wiki/Special:FilePath/Rembrandt_van_Rijn_-_Self-Portrait_-_Google_Art_Project.jpg',
    title: 'Self-Portrait',
    year: '1659',
    museum: 'National Gallery of Art, Washington'
  },
  'Johannes Vermeer': {
    url: 'https://commons.wikimedia.org/wiki/Special:FilePath/1665_Girl_with_a_Pearl_Earring.jpg',
    title: 'Girl with a Pearl Earring',
    year: '1665',
    museum: 'Mauritshuis, The Hague'
  },
  'William-Adolphe Bouguereau': {
    url: 'https://commons.wikimedia.org/wiki/Special:FilePath/William-Adolphe_Bouguereau_(1825-1905)_-_The_Birth_of_Venus_(1879).jpg',
  ...
  'Claude Monet': {
    url: 'https://commons.wikimedia.org/wiki/Special:FilePath/Claude_Monet,_Impression,_soleil_levant.jpg',
    title: 'Impression, Sunrise',
    year: '1872',
    museum: 'Musée Marmottan Monet, Paris'
  },
  'Pierre-Auguste Renoir': {
    url: 'https://commons.wikimedia.org/wiki/Special:FilePath/Pierre-Auguste_Renoir,_Le_Moulin_de_la_Galette.jpg',
    title: 'Bal du Moulin de la Galette',
    year: '1876',
    museum: 'Musée d\'Orsay, Paris'
  },
  'Édouard Manet': {
    url: 'https://commons.wikimedia.org/wiki/Special:FilePath/Edouard_Manet_-_Olympia_-_Google_Art_Project_3.jpg',
    title: 'Olympia',
    year: '1863',
    museum: 'Musée d\'Orsay, Paris'
  },
  'John Singer Sargent': {
    url: 'https://commons.wikimedia.org/wiki/Special:FilePath/John_Singer_Sargent_-_Carnation,_Lily,_Lily,_Rose_-_Google_Art_Project.jpg',
    title: 'Carnation, Lily, Lily, Rose',
    year: '1885–86',
    museum: 'Tate Britain, London'
  },
  'Joaquín Sorolla': {
    url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d9/Joaqu%C3%ADn_Sorolla_y_Bastida_-_Strolling_along_the_Seashore_-_Google_Art_Project.jpg/960px-Joaqu%C3%ADn_Sorolla_y_Bastida_-_Strolling_along_the_Seashore_-_Google_Art_Project.jpg',
  ...
  'Édouard Vuillard': {
    url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/bb/Edouard_Vuillard_-_Interior_-_Belgrade.jpg/960px-Edouard_Vuillard_-_Interior_-_Belgrade.jpg',
    title: 'Interior',
    year: 'c. 1899',
    museum: 'National Museum of Serbia, Belgrade'
  },
  'Pierre Bonnard': {
    url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/12/The_dining_room_in_the_country_by_Pierre_Bonnard_%281913%29.jpg/960px-The_dining_room_in_the_country_by_Pierre_Bonnard_%281913%29.jpg',
    title: 'The Dining Room in the Country',
    year: '1913',
    museum: 'Minneapolis Institute of Art'
  },
  'Giorgione': {
    url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6d/Giorgione_-_Young_Woman_%28%E2%80%9CLaura%E2%80%9D%29_-_Google_Art_Project.jpg/960px-Giorgione_-_Young_Woman_%28%E2%80%9CLaura%E2%80%9D%29_-_Google_Art_Project.jpg',
    title: 'Laura',
    year: '1506',
    museum: 'Kunsthistorisches Museum, Vienna'
  },
  'Giovanni Bellini': {
    url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d7/Giovanni_Bellini_-_Saint_Francis_in_the_Desert_-_Google_Art_Project.jpg/960px-Giovanni_Bellini_-_Saint_Francis_in_the_Desert_-_Google_Art_Project.jpg',
    title: 'Saint Francis in the Desert',
    year: 'c. 1480',
    museum: 'Frick Collection, New York'
  },
  'Santiago Rusiñol': {
    url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/73/Santiago_Rusi%C3%B1ol_-_Garden_of_Montmartre_-_Google_Art_Project.jpg/960px-Santiago_Rusi%C3%B1ol_-_Garden_of_Montmartre_-_Google_Art_Project.jpg',
    title: 'Garden of Montmartre',
    year: 'c. 1899',
    museum: 'Museu Nacional d\'Art de Catalunya'
  },
  'Anders Zorn': {
    url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/ed/Anders_Zorn_Omnibus.jpg/960px-Anders_Zorn_Omnibus.jpg',
    title: 'Omnibus',
    year: '1892',
  ...
  'Georges de La Tour': {
    url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/73/The_Penitent_Magdalen_MET_DT7252.jpg/960px-The_Penitent_Magdalen_MET_DT7252.jpg',
    title: 'The Penitent Magdalene',
    year: 'c. 1640',
    museum: 'Metropolitan Museum of Art'
  },
  'Jan van Eyck': {
    url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/33/Van_Eyck_-_Arnolfini_Portrait.jpg/960px-Van_Eyck_-_Arnolfini_Portrait.jpg',
    title: 'The Arnolfini Portrait',
    year: '1434',
    museum: 'National Gallery, London'
  },
  'Hans Holbein the Younger': {
    url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/88/Hans_Holbein_the_Younger_-_The_Ambassadors_-_Google_Art_Project.jpg/960px-Hans_Holbein_the_Younger_-_The_Ambassadors_-_Google_Art_Project.jpg',
    title: 'The Ambassadors',
    year: '1533',
    museum: 'National Gallery, London'
  },
  'Rachel Ruysch': {
    url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/32/Den_Haag_-_Mauritshuis_-_Rachel_Ruysch_%281664-1750%29_-_Vase_with_Flowers_1700.jpg/960px-Den_Haag_-_Mauritshuis_-_Rachel_Ruysch_%281664-1750%29_-_Vase_with_Flowers_1700.jpg',
  ...
  'Jan van Huysum': {
    url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a1/Van_Huysum%2C_Jan_-_Vase_with_Flowers_-_Google_Art_Project.jpg/960px-Van_Huysum%2C_Jan_-_Vase_with_Flowers_-_Google_Art_Project.jpg',
    title: 'Vase with Flowers',
    year: 'c. 1722',
    museum: 'Hermitage Museum, St Petersburg'
  },
  'Gustav Klimt': {
    url: 'https://commons.wikimedia.org/wiki/Special:FilePath/Gustav_Klimt_016.jpg',
    title: 'The Kiss',
    year: '1908–09',
  ...
  'Fernand Khnopff': {
    url: 'https://commons.wikimedia.org/wiki/Special:FilePath/Fernand_Khnopff013.jpg',
    title: 'Des caresses',
    year: '1896',
  ...
  'Thomas Cole': {
    url: 'https://commons.wikimedia.org/wiki/Special:FilePath/Thomas_Cole_-_The_Oxbow_(Met).jpg',
    title: 'The Oxbow',
    year: '1836',
  ...
  'Asher B. Durand': {
    url: 'https://commons.wikimedia.org/wiki/Special:FilePath/Kindred_Spirits_-_Asher_Brown_Durand.jpg',
    title: 'Kindred Spirits',
    year: '1849',
    museum: 'Crystal Bridges Museum, Bentonville'
  },
  'Frederic Church': {
    url: 'https://commons.wikimedia.org/wiki/Special:FilePath/Cotopaxi_church.jpg',
    title: 'Cotopaxi',
    year: '1862',
  ...
  'Albert Bierstadt': {
    url: 'https://commons.wikimedia.org/wiki/Special:FilePath/Albert_Bierstadt_-_Among_the_Sierra_Nevada%2C_California_-_Google_Art_Project.jpg',
    title: 'Among the Sierra Nevada, California',
    year: '1868',
    museum: 'Smithsonian American Art Museum'
  },
  'Jean-Léon Gérôme': {
    url: 'https://commons.wikimedia.org/wiki/Special:FilePath/JEAN-L%C3%89ON_G%C3%89R%C3%94ME_-_J%C3%B3venes_griegos_presenciando_una_pelea_de_gallos_(Museo_de_Orsay,_Par%C3%ADs,_1846._%C3%93leo_sobre_lienzo,_143_x_204_cm).jpg',
    title: 'Young Greeks Attending a Cockfight',
    year: '1846',
    museum: 'Mus\u00e9e d\u2019Orsay, Paris',
    crop: 'center 35%'
  },
  'Lawrence Alma-Tadema': {
    url: 'https://commons.wikimedia.org/wiki/Special:FilePath/Alma-Tadema_Unconscious_Rivals_1893.jpg',
    title: 'Unconscious Rivals',
    year: '1893',
    museum: 'Bristol Museum and Art Gallery',
    crop: 'center 30%'
  },
  'Edgar Degas': {
    url: 'https://commons.wikimedia.org/wiki/Special:FilePath/Edgar_Degas_-_The_Bellelli_Family_-_Google_Art_Project.jpg',
...
function ArtworkBanner({
  ...
  if (!aw || err) {
    ...
    }, sortPigments(artist.pigments).map(p => /*#__PURE__*/React.createElement("div", {
      key: p.n,
      title: p.n,
      style: {
        width: 22,
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      height: '100%',
      objectFit: 'cover',
      objectPosition: aw.crop || 'center 20%',
      display: 'block',
      marginLeft: '-1px',
      transform: aw.zoom ? `scale(${aw.zoom})` : undefined,
      transformOrigin: aw.crop || 'center 20%'
    },
    onError: () => setErr(true)
  })), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, aw.title), /*#__PURE__*/React.createElement("span", {
    style: {
  ...
  }, aw.year)), /*#__PURE__*/React.createElement("div", {
    style: {
      fontFamily: 'var(--font-sans)',
      fontSize: 10,
      color: 'var(--fg3)',
...
function findModernPigments(historicalName, max = 4) {
  ...
  const brands = [{
    data: window.GAMBLIN_FAMILIES,
    brand: 'Gamblin'
  }, {
    data: window.WN_FAMILIES,
    brand: 'W&N'
  }, {
    data: window.MH_FAMILIES,
    brand: 'M. Harding'
  }, {
    data: window.OH_FAMILIES,
    brand: 'Old Holland'
  }];
  const results = [];
  const seen = new Set();
...
function MastersDetail({
  ...
  if (!artist) return /*#__PURE__*/React.createElement("aside", {
    className: "detail"
  }, /*#__PURE__*/React.createElement("p", {
    className: "empty"
  }, "Select a master to explore their palette and historical context."));
  if (pigment) {
    const info = MNOTES[pigment.n] || {
      period: '',
      origin: '',
      note: 'Historical notes not available for this pigment.'
    };
    ...
    return /*#__PURE__*/React.createElement("aside", {
      className: "detail is-pigment" + (shown ? " has-sel" : "")
    }, /*#__PURE__*/React.createElement("button", {
      className: "detail-back",
      onClick: onBack
    }, /*#__PURE__*/React.createElement(MBack, null), artist.name.split(' ').pop()), /*#__PURE__*/React.createElement("div", {
      className: "big",
      style: {
        background: pigment.c
      }
    }, /*#__PURE__*/React.createElement("div", {
      className: "valuechip",
      style: {
        color: valDark ? "rgba(0,0,0,0.70)" : "rgba(255,255,255,0.85)"
      }
    }, /*#__PURE__*/React.createElement("div", {
      className: "sq",
      style: {
      ...
      className: "specs"
    }, /*#__PURE__*/React.createElement("dt", null, "Origin"), /*#__PURE__*/React.createElement("dd", null, info.origin || '—'), /*#__PURE__*/React.createElement("dt", null, "Era"), /*#__PURE__*/React.createElement("dd", null, era.full), /*#__PURE__*/React.createElement("dt", null, "Master"), /*#__PURE__*/React.createElement("dd", null, artist.name)), /*#__PURE__*/React.createElement("p", {
      className: "note"
    }, info.note), (() => {
      ...
      return /*#__PURE__*/React.createElement("div", {
      ...
      }, "Modern Equivalents"), /*#__PURE__*/React.createElement("ul", {
        className: "m-pig-list"
      }, matches.map((m, i) => /*#__PURE__*/React.createElement("li", {
        key: i,
        className: "m-pig"
      }, /*#__PURE__*/React.createElement("div", {
        className: "m-pig-sw",
        ...
        className: "m-pig-name"
      }, m.name), /*#__PURE__*/React.createElement("div", {
        className: "m-pig-meta"
      }, m.brand, " \xB7 ", m.opacity))))));
    })());
  }
  ...
  return /*#__PURE__*/React.createElement("aside", {
    ...
    className: "detail-back",
    onClick: onBack
  }, /*#__PURE__*/React.createElement(MBack, null), "Palette"), /*#__PURE__*/React.createElement(ArtworkBanner, {
    key: artist.name,
    artist: artist
  }), /*#__PURE__*/React.createElement("p", {
    className: "t-eyebrow",
  ...
  }, era.full), /*#__PURE__*/React.createElement("h3", {
    style: {
      display: 'flex',
    ...
    className: "colname"
  }, artist.name), /*#__PURE__*/React.createElement("span", {
    style: {
      fontStyle: 'normal',
      fontSize: 13,
      color: 'var(--fg3)',
...
function MastersDrawer({
    ...
    return {
      ...
      right() {
        ...
        const s = el.scrollLeft,
          t = Math.min(el.scrollWidth - el.clientWidth, s + el.clientWidth * 0.7);
        scroll(el, s, t);
      },
      left() {
        const el = ref.current;
        if (!el) return;
        const s = el.scrollLeft,
          t = Math.max(0, s - el.clientWidth * 0.7);
        scroll(el, s, t);
      }
    };
  }
  ...
  useEffect(() => {
    [tabsRef, artistsRef].forEach(ref => {
      ...
      s.check();
      el.addEventListener('scroll', s.check, {
        passive: true
      });
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "drawer drawer-masters" + (open ? " open" : ""),
    role: "dialog",
    "aria-label": "Old Masters palette"
  }, /*#__PURE__*/React.createElement("div", {
    className: "drawer-head"
  }, /*#__PURE__*/React.createElement("div", {
    className: "brandtabs-wrap chev-wrap"
  }, /*#__PURE__*/React.createElement("button", {
    className: "fam-nav prev" + (showEraLeft ? " show" : ""),
    onClick: eraScroll.left,
    "aria-label": "Scroll eras left",
    tabIndex: showEraLeft ? 0 : -1
    ...
    className: "fam-nav next" + (showEraRight ? " show" : ""),
    onClick: eraScroll.right,
    "aria-label": "Scroll eras right",
    tabIndex: showEraRight ? 0 : -1
  }, /*#__PURE__*/React.createElement("svg", {
    viewBox: "0 0 24 24",
    fill: "none",
    stroke: "currentColor",
    ...
    className: "brandtabs",
    ref: tabsRef
  }, MDATA.map((e, i) => /*#__PURE__*/React.createElement("button", {
    key: e.id,
    className: "btab" + (i === eraIdx ? " active" : ""),
    onClick: () => pickEra(i)
    ...
    onClick: artistScroll.left,
    "aria-label": "Scroll artists left",
    tabIndex: showArtistLeft ? 0 : -1
  }, /*#__PURE__*/React.createElement("svg", {
    viewBox: "0 0 24 24",
    fill: "none",
    stroke: "currentColor",
    ...
    className: "fam-nav next" + (showArtistRight ? " show" : ""),
    onClick: artistScroll.right,
    "aria-label": "Scroll artists right",
    tabIndex: showArtistRight ? 0 : -1
  }, /*#__PURE__*/React.createElement("svg", {
    viewBox: "0 0 24 24",
    fill: "none",
    stroke: "currentColor",
    ...
    return /*#__PURE__*/React.createElement("button", {
      key: a.name,
      className: "fam" + (i === artistIdx ? " active" : ""),
      onClick: () => pickArtist(i)
    }, /*#__PURE__*/React.createElement("span", {
      className: "seed",
      style: {
        background: seed
      }
    }), a.short || a.name.split(' ').pop());
  }))), /*#__PURE__*/React.createElement("div", {
    className: "drawer-body"
  }, /*#__PURE__*/React.createElement("div", {
    className: "wells"
  }, sortPigments(artist.pigments).map(p => /*#__PURE__*/React.createElement("button", {
    key: p.n,
    className: "well" + (sel && sel.n === p.n ? " sel" : ""),
    onClick: () => pickPigment(p)
  }, /*#__PURE__*/React.createElement("div", {
    className: "chip",
    style: {
      background: p.c
    ...
    className: "nm"
  }, p.n)))), /*#__PURE__*/React.createElement(MastersDetail, {
    artist: artist,
    era: era,
    pigment: sel,
    shown: detailShown,

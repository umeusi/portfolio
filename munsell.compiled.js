...
const PIGMENTS = (() => {
  const sources = [["Gamblin", window.GAMBLIN_FAMILIES], ["Winsor & Newton", window.WN_FAMILIES], ["Michael Harding", window.MH_FAMILIES], ["Old Holland", window.OH_FAMILIES]];
  const out = [];
  sources.forEach(([brand, fams]) => (fams || []).forEach(f => (f.colors || []).forEach(c => out.push({
    name: c.name,
    hex: c.hex,
    pigment: c.pigment,
    opacity: c.opacity,
...
const HUES = (() => {
  ...
  ANCHOR.forEach((ang, f) => ctrl.push({
    idx: f * 4 + 1,
    ang
  }));
  ctrl.push({
    ...
    VALUES.forEach(v => {
      ...
      for (let r = 1; r <= rings; r++) {
        ...
        chips.push({
          ...
          cy: (v - 5) * V_UNIT,
          tnx: -Math.sin(hue.dispAngle),
          tnz: Math.cos(hue.dispAngle),
          rdx: Math.cos(hue.dispAngle),
          rdz: Math.sin(hue.dispAngle)
        });
      }
    });
  });
...
function Solid({
  ...
  useEffect(() => {
    ...
    const resize = () => {
      ...
      can.width = Math.round(r.width * dpr);
      can.height = Math.round(r.height * dpr);
    ...
    const renderFrame = () => {
      ...
      bg.addColorStop(0, "#ECEAE4");
      bg.addColorStop(0.55, "#E2E2E2");
      bg.addColorStop(1, "#CFCEC8");
      ctx.fillStyle = bg;
      ...
      for (const it of items) {
        ...
        const mx = (P[0][0] + P[2][0]) / 2,
          my = (P[0][1] + P[2][1]) / 2;
        if (!c.neutral && !dim) S.proj.push({
          mx,
          my,
          c,
          r: Math.hypot(P[0][0] - P[2][0], P[0][1] - P[2][1]) / 2
        });
      }
    };
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    height: "14",
    fill: "currentColor"
  })), /*#__PURE__*/React.createElement("span", null, paused ? "Play" : "Pause"))), /*#__PURE__*/React.createElement("div", {
    className: "m-hint"
  }, "Drag to turn \xB7 click a chip to read it"));
}
...
function HuePage({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "t-eyebrow"
  }, "Hue page"), /*#__PURE__*/React.createElement("h3", {
    className: "m-page-title"
  }, STEP_LABEL[1], FAMILIES[fam], " ", /*#__PURE__*/React.createElement("span", {
    className: "m-page-sub"
  }, FAM_NAME[fam])), /*#__PURE__*/React.createElement("p", {
    className: "m-page-note"
  }, "Read down a column to see which ", /*#__PURE__*/React.createElement("em", null, "values"), " a given chroma can reach \u2014 the page's edge is the gamut. Strongest chroma sits where the silhouette bulges."), /*#__PURE__*/React.createElement("div", {
    className: "m-grid-wrap"
  }, /*#__PURE__*/React.createElement("div", {
    className: "m-vaxis"
  }, /*#__PURE__*/React.createElement("span", {
    className: "m-axis-cap"
  }, "Value"), [...VALUES].reverse().map(v => /*#__PURE__*/React.createElement("span", {
    key: v,
    className: "m-vtick"
  }, v))), /*#__PURE__*/React.createElement("div", {
    className: "m-grid"
  }, [...VALUES].reverse().map(v => /*#__PURE__*/React.createElement("div", {
    className: "m-grow",
    key: v
  }, cols.map(r => {
    ...
    return /*#__PURE__*/React.createElement("button", {
      ...
      style: on ? {
        background: lch2hex(v * 10, r * RING, page.ang)
      } : undefined,
      onClick: () => on && onPick({
        fam,
        v,
    ...
    className: "m-caxis"
  }, cols.map(r => /*#__PURE__*/React.createElement("span", {
    key: r,
    className: "m-ctick"
  }, r * 2)), /*#__PURE__*/React.createElement("span", {
    className: "m-axis-cap m-caxis-cap"
  }, "Chroma \u2192")))));
}
...
function Suggestions({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "t-eyebrow"
  }, "Suggested pigments"), /*#__PURE__*/React.createElement("p", {
    className: "m-suggest-note"
  }, "Tube colors sitting nearest this hue, value & chroma \u2014 drawn from the four brands in the pigment library."), /*#__PURE__*/React.createElement("ul", {
  ...
  }, p.brand, " \xB7 ", p.pigment)), /*#__PURE__*/React.createElement("span", {
    className: "m-pig-de m-de-" + word(de).toLowerCase()
  }, word(de))))));
}
...
function Readout({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "m-swatch-not",
    style: {
      color: dark ? "rgba(17,17,17,0.7)" : "rgba(250,248,244,0.9)"
    }
  }, STEP_LABEL[1], FAMILIES[sel.fam], " ", sel.v, "/", sel.chroma)), /*#__PURE__*/React.createElement("dl", {
    className: "m-specs"
  }, /*#__PURE__*/React.createElement("dt", null, "Hue"), /*#__PURE__*/React.createElement("dd", null, STEP_LABEL[1], FAMILIES[sel.fam], " \xB7 ", FAM_NAME[sel.fam]), /*#__PURE__*/React.createElement("dt", null, "Value"), /*#__PURE__*/React.createElement("dd", null, sel.v, " ", /*#__PURE__*/React.createElement("span", {
    className: "m-dim"
  }, "of 9")), /*#__PURE__*/React.createElement("dt", null, "Chroma"), /*#__PURE__*/React.createElement("dd", null, sel.chroma, " ", /*#__PURE__*/React.createElement("span", {
    className: "m-dim"
  }, "/", sel.chroma)), /*#__PURE__*/React.createElement("dt", null, "sRGB"), /*#__PURE__*/React.createElement("dd", {
    className: "m-mono"
  }, hex.toUpperCase())));
}
...
function ChevRow({
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "families-wrap m-families-wrap"
  }, /*#__PURE__*/React.createElement("button", {
    className: "fam-nav prev" + (navL ? " show" : ""),
    onClick: () => scroll(-1),
    "aria-label": "Scroll hues left",
    tabIndex: navL ? 0 : -1
  }, /*#__PURE__*/React.createElement("svg", {
    viewBox: "0 0 24 24",
    fill: "none",
...
function MunsellPanel({
  ...
  const pickFam = f => {
    ...
    setSel(s => ({
      fam: f,
      v: s.v,
      chroma: Math.min(s.chroma, maxCh)
    }));
  };
  const pick = next => {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "drawer m-drawer" + (open ? " open" : ""),
    role: "dialog",
    "aria-label": "Munsell color solid"
  }, /*#__PURE__*/React.createElement("div", {
    ...
    className: "t-eyebrow"
  }, "Munsell color theory"), /*#__PURE__*/React.createElement("h3", {
    className: "m-title"
  }, "Hue \xB7 Value \xB7 Chroma"))), /*#__PURE__*/React.createElement(ChevRow, {
    className: "families m-families"
  }, FAMILIES.map((fm, i) => /*#__PURE__*/React.createElement("button", {
    key: fm,
    className: "fam" + (focusFam === i ? " active" : ""),
    onClick: () => pickFam(i)
  }, /*#__PURE__*/React.createElement("span", {
    className: "seed",
    style: {
      background: familySwatch(i)
    }
  }), STEP_LABEL[1], fm))), /*#__PURE__*/React.createElement("div", {
    className: "drawer-body m-body"
  }, open && /*#__PURE__*/React.createElement(Solid, {
    focusFam: focusFam,
    sel: sel,
    onPick: pick
  }), /*#__PURE__*/React.createElement("div", {
    className: "m-side" + (infoShown ? " shown" : "")
  }, /*#__PURE__*/React.createElement("button", {
    className: "m-back",
    onClick: () => setInfoShown(false),
    "aria-label": "Back to color wheel"
  }, /*#__PURE__*/React.createElement("svg", {
    viewBox: "0 0 24 24",
    fill: "none",
    stroke: "currentColor",
    ...
    d: "m15 18-6-6 6-6"
  })), "Color wheel"), /*#__PURE__*/React.createElement(HuePage, {
    fam: focusFam,
    sel: sel,
    onPick: pick
